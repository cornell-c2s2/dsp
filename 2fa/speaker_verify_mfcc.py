...
def mfcc_cepstral_features(y, sr, n_mfcc=20, n_fft=512, win_length=400, hop_length=160):
...
def train(
    ...
    clf = Pipeline([("scaler", StandardScaler()), ("lr", base)])
...
def main():
    ...
    if args.cmd == "train":
        ...
        predict_folder(
            folder=args.folder, model_path=args.model, threshold_path=args.threshold
        )
