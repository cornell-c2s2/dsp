...
def dump_gmms(filenames: list[str], outnames: list[str]):
    ...
    with open("models/gmm_params.inc", "w") as f:
        f.write("// autogenerated by speaker/dump_model.py\n\n")
        f.write("#ifndef GMM_PARAMS_INC\n")
        f.write("#define GMM_PARAMS_INC\n\n")
        for i in range(len(filenames)):
            ...
            for k in range(K):
                ...
                if k < K - 1:
                    f.write(",\n")
            f.write("\n};\n\n")
            f.write("#endif // DOUBLE_GMM\n\n")
        f.write("#endif // GMM_PARAMS_INC\n")
