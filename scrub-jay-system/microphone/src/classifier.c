...
int main()
{
    ...
    char folder[] = "src/16k-single-test";
    ...
    while ((entry = readdir(directory)) != NULL)
    {
        if (strcmp(entry->d_name, ".") != 0 && strcmp(entry->d_name, "..") != 0)
        {
            ...
            for (int idx = 0; idx < num_midpoints; idx++)
            {
                ...
                double sum_above = sum_intense(5000, 7000, 0.18, frequencies_bp, freq_bins_bp, times_bp, time_bins_bp, intensity_bp, midpoint);
                double sum_middle = sum_intense(2500, 5000, 0.05, frequencies_bp, freq_bins_bp, times_bp, time_bins_bp, intensity_bp, midpoint);
                double sum_below = sum_intense(500, 2500, 0.18, frequencies_bp, freq_bins_bp, times_bp, time_bins_bp, intensity_bp, midpoint);
                ...
                if (sum_middle < 50 && sum_above > 200 && sum_below > 200)
                {
                    has_a_scrub = true;
